...
public class DropdownMenuButtonGroup extends ButtonGroup<DropdownMenuButtonGroup>
{
    final private DropdownMenu menu;
    final private Button button;
    
    public DropdownMenuButtonGroup()
    {
        this.button=returnAddInner(new Button());
        this.menu=returnAddInner(new DropdownMenu(button));
