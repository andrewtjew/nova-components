...
public class ObjectMapperOld2
{
	...
	{
		ObjectMapperOld2.objectMapper.writeValue(outputStream, object);
	}
	...
	{
		return ObjectMapperOld2.objectMapper.readValue(jsonText, type);
	}

	public static <OBJECT> OBJECT read2(InputStream inputStream, Class<OBJECT> type) throws Exception
	{
		return ObjectMapperOld2.objectMapper.readValue(inputStream, type);
	}
	...
	final static ObjectMapperOld2 mapper=new ObjectMapperOld2();
	
	private ObjectMapperOld2()
	{
	}
...
/*
	private void writeField(StringBuilder sb, Class<?> fieldType, Object object) throws Exception
    {
            if (fieldType.isPrimitive())
            {
                sb.append(object);
